...
if __name__ == "__main__" : 
  ...
  parser.add_argument( '-O', '--output_filename', default='scifi_virtual_dict', help='Set the output filename')
  ...
  parser.add_argument( '--invert', action='store_true', help='Invert the dictionary.' )
  parser.add_argument( '-P', '--print_all_planes', action='store_true', help='Prints out a list of all the virtual planes' )
...
#    virtual_plane_dict = find_virtual_planes(file_reader, namespace.max_num_events)
    ...
    if namespace.invert :
      scifi_virtual_dict = invert_dict(scifi_virtual_dict)
    if namespace.print_all_planes :
      print_virtual_plane_dict(virtual_plane_dict)
