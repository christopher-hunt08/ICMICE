...
def get_engine_parser(parser, job_name="some_analysis") :
  ...
  parser.add_argument( '-B', '--beam_selection', type=int, default=None, help="Specify the plane at which beam selection should occur. If no beam selection module is included the full distribution is saved." )
  parser.add_argument( '--reference_plane', type=int, default=1, help="Specify the reference plane for the analysis, should be a positive integer." )
  ...
  parser.add_argument( '-L', '--max_load_events', type=int, help='Maximum number of events to load.' )
...
def print_beam_selection_help() :
  print
  print "Some help string..."
  print
